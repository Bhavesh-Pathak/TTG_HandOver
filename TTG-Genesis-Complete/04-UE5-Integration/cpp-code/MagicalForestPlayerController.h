...
#include "MagicalForestPlayerController.generated.h"

UCLASS(BlueprintType, Blueprintable)
class GAMEMODULE_API AMagicalForestPlayerController : public APlayerController
{
    GENERATED_BODY()

public:
    AMagicalForestPlayerController();
